...
if(isset($_SESSION['usuario'])) {
  ...
  $mensajeInicioSesion = "Bienvenido $usuario " ;
}
?>
<!DOCTYPE html>
<html lang="es">
  ...
  <body>
    ...
    <?php if(isset($mensajeInicioSesion)): ?>
      <script>
        ...
        alert("<?php echo $mensajeInicioSesion; ?>");
      </script>
    <?php endif; ?>
    <!-- Header Start -->
    <div class="container-fluid bg-primary px-0 px-md-5 mb-5">
      <div class="row align-items-center px-3">
        <div class="col-lg-6 text-center text-lg-left">
          <h4 class="text-white mb-4 mt-5 mt-lg-0">Acerca de...</h4>
          <h1 class="display-3 font-weight-bold text-white">
           
          </h1>
          <p class="text-white mb-4">
            Esta pagina es para ayudar a los maestros, para capturar calificaciones y tener un control de sus alumnos.
          </p>
          
        </div>
        <div class="col-lg-6 text-center text-lg-right" style="padding: 30px">
            <img class="img-fluid mt-1" src="img/libro.png" width="130px" height="130px" alt="" />
        </div>
      </div>
    </div>
    <!-- Header End -->
