            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Student Details
                            <a href="addalumnos.php" class="btn btn-primary float-right">Add Students</a>
                        </h4>
                    </div>
                    <div class="card-body">
                                        ...
                                        foreach($query_run as $student)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $student['nombre']; ?></td>
                                                    ...
                                                    <a href="student-edit.php?id=<?= $student['id_alumno']; ?>" class="btn btn-success btn-sm">Edit</a>
                                                    <form action="code.php" method="POST" class="d-inline">
                                                        <button type="submit" name="delete_student" value="<?=$student['id_alumno'];?>" class="btn btn-danger btn-sm">Delete</button>
                                                    </form>
                                                </td>
                                            </tr>
                                            <?php
